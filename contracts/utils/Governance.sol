...
contract Governance is ERC20 {
    ...
    */
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        uint224 delegatorBalance = uint224(balanceOf(delegator)); // balance of underlying (not scaled);
    ...
    function _moveDelegates(address srcRep, address dstRep, uint224 amount) internal {
